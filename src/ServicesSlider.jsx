...
const SERVICES = [
  {
    ...
    summary: "Architecting resilient, scalable platforms for mission-critical operations with enterprise SLAs.",
    details: "We design and build modular platforms with multi-tenant support, observability, and automated CI/CD pipelines. Each platform is engineered with fault tolerance, distributed tracing, and zero-downtime deployment strategies.",
    icon: "enterprise",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/19b52d4e7-dfe0-452d-82d8-c25dd27a5696.png",
    tags: ["Microservices", "Cloud-Native", "SLA"],
  },
  {
    id: "ecommerce",
    title: "Ecommerce & Conversion",
    summary: "High-converting commerce experiences with headless architecture and fast checkout flows.",
    details: "From catalog modelling to payment orchestration and personalization, we optimize every step of the funnel to increase AOV and lifetime value.",
    icon: "ecommerce",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/1033f9249-e463-4edd-8597-7139e827baef.png",
    tags: ["Headless", "Payments", "AOV"],
  },
  {
    id: "design",
    title: "UX, UI & Design Systems",
    summary: "Design systems that scale: accessible, consistent, and delightful interfaces.",
    details: "We create component libraries, token systems, and documentation that empower product teams to ship faster while preserving brand integrity.",
    icon: "design",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/18a8423c7-e9b4-464f-876b-8c4547cc60d4.png",
    tags: ["Design Tokens", "Components", "a11y"],
  },
  {
    id: "api",
    title: "API Strategy & Integrations",
    summary: "Secure, developer-friendly APIs and integrations that unlock ecosystem value.",
    details: "We design RESTful and GraphQL APIs, implement robust auth, and integrate third-party services with observability and test coverage.",
    icon: "api",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/1ba1d9188-5382-4f30-9f44-8c0eac2f75fc.png",
    tags: ["REST", "GraphQL", "OAuth"],
  },
  {
    id: "performance",
    title: "Performance Engineering",
    summary: "Speed-first engineering: Lighthouse-grade performance, caching, and edge delivery.",
    details: "We optimize critical rendering paths, implement smart caching strategies, and tune infrastructure for consistent, fast experiences worldwide.",
    icon: "performance",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/1a1a14102-1abf-406d-83f8-d40786c5ba16.png",
    tags: ["Lighthouse", "CDN", "Edge"],
  },
  {
    id: "security",
    title: "Security & Compliance",
    summary: "Security by design with compliance readiness for regulated industries.",
    details: "Threat modelling, secure architecture reviews, and automated testing to reduce risk and meet regulatory requirements.",
    icon: "security",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/1770101e8-a401-4acd-a14e-9173f1c0a3f1.png",
    tags: ["SOC 2", "GDPR", "WAF"],
  },
  {
    id: "growth",
    title: "Growth, Analytics & CRO",
    summary: "Data-driven growth programs: experimentation, analytics, and conversion optimization.",
    details: "We instrument analytics, run rigorous A/B programs, and translate insights into product and marketing wins.",
    icon: "growth",
    image: "https://image.qwenlm.ai/public_source/d79ffea0-038f-4ed1-8528-d927c2490921/1e4176408-8c6d-42ea-8646-7e3fd4c0e17b.png",
...
function ServiceCard({ service, index, isActive, onClick, isExpanded, ambientColor }) {
...
function DotsNav({ services, activeIndex, onNavigate, ambientColor }) {
  return (
    <nav className="dots-nav" aria-label="Services navigation">
...
export default function ServicesSlider({ services = SERVICES }) {
  ...
  return (
    <section id="services" className="services-carousel-container" aria-labelledby="services-showcase-title" ref={containerRef}>
      <style>{`
        ...
        .autoplay-icon { width: 10px; height: 10px; }
